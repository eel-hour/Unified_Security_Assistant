...
impl TheHiveClient {
    ...
    pub async fn get_alerts(
        ...
        // Create listAlert operation
        let list_alert_op = QueryOperation {
            _name: Some("listAlert".to_string()),
        ...
        // The query must start with the main query operation, then modifiers like paging
        let query_payload = InputQuery {
            query: Some(vec![list_alert_op, page_op]),
            exclude_fields: None,
        };
